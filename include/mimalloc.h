...
mi_decl_nodiscard __attribute__((visibility("default"))) mi_heap_t *mi_heap_new(void);
mi_decl_export void       mi_heap_delete(mi_heap_t* heap);
mi_decl_export void       mi_heap_destroy(mi_heap_t* heap);
__attribute__((visibility("default"))) mi_heap_t *mi_heap_set_default(mi_heap_t *heap);
__attribute__((visibility("default"))) mi_heap_t *mi_heap_get_default(void);
...
__attribute__((visibility("default"))) bool mi_heap_visit_blocks(const mi_heap_t *heap, bool visit_all_blocks, mi_block_visit_fun *visitor, void *arg);
